...
k3_str_as_example = "PGdyYXBobWwgeG1sbnM9Imh0dHA6Ly9ncmFwaG1sLmdyYXBoZHJhd2luZy5vcmcveG1sbnMiIHhtbG5zOnhzaT0iaHR0cDo" \
                    "vL3d3dy53My5vcmcvMjAwMS9YTUxTY2hlbWEtaW5zdGFuY2UiCiAgICAgICAgIHhzaTpzY2hlbWFMb2NhdGlvbj0iaHR0cD" \
                    "ovL2dyYXBobWwuZ3JhcGhkcmF3aW5nLm9yZy94bWxucyBodHRwOi8vZ3JhcGhtbC5ncmFwaGRyYXdpbmcub3JnL3htbG5zL" \
                    "zEuMC9ncmFwaG1sLnhzZCI+CiAgICA8Z3JhcGggZWRnZWRlZmF1bHQ9InVuZGlyZWN0ZWQiPgogICAgICAgIDxub2RlIGlk" \
                    "PSIwIi8+CiAgICAgICAgPG5vZGUgaWQ9IjEiLz4KICAgICAgICA8bm9kZSBpZD0iMiIvPgogICAgICAgIDxlZGdlIHNvdXJ" \
                    "jZT0iMCIgdGFyZ2V0PSIxIi8+CiAgICAgICAgPGVkZ2Ugc291cmNlPSIwIiB0YXJnZXQ9IjIiLz4KICAgICAgICA8ZWRnZS" \
                    "Bzb3VyY2U9IjEiIHRhcmdldD0iMiIvPgogICAgPC9ncmFwaD4KPC9ncmFwaG1sPg=="

data_path = "data.db"


# TODO manage.py with start and stop server
...
def create_app():
    ...
    book_embedding_schema = api.model(
        'Book embedding',
        {
            ...
            'graph': fields.String(description='This field contains a graphml definition encoded with base64. '
                                   ...
                                   required=True, example=k3_str_as_example),
        ...
        def post(self):
            ...
            try:
                ...
                try:
                    ...
                    node_ids, edges = parse_graphml_string(graph_str)
                ...
                raise InternalServerError(
                    "The error {} \noccured from this body \n{}".format(str(e), request.get_data(as_text=True))) from e
    ...
    def processing_finished_callback(future: Future):
        ...
        try:
            ...
            data_store.updateEntry(id, entity)
            raise e
