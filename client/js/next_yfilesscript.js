...
require([
	...
	*/
	...
	function highlightEdgeArcStyle(edge, directed){
		...
		// Set Style
		graphComponent.graph.setStyle(edge, getEdgeArcStyle(height, stroke, directed));
	}
	...
	function highlightEdgePolylineStyle(edge, directed) {
		...
		let stroke = getStrokeString(getEdgeStrokeThickness(), getEdgeStrokeDefaultLineStyle(), color);
		// Set Style
		graphComponent.graph.setStyle(edge, getEdgePolylineStyle(stroke, directed));
	}
	...
	*/
	...
	function getEdgeArcStyle(height, stroke, directed) {
		if(directed){
	...
	function getEdgePolylineStyle(stroke, directed) {
		if (directed){
