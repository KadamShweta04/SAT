...
%
%\begin{center}
%\url{https://github.com/linear-layouts/SAT}
%\end{center} 
%
...
%(that is by default visible, but it can also be hidden to facilitate the creation of the graph; refer to the bottom part of Fig.~\ref{fig:editingmode})
...
%By selecting one or more vertices and by right-clicking on one of them, the user is able to assign the edges incident to the selected vertices to specific pages of the layout. In particular, 
...
% available at the server's interface :
%
%\begin{center}
...
%For security reasons, however, we have also imposed restrictions to ensure that the system is used properly. 
